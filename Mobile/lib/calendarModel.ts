// Pure calendar math shared by CalendarSheet — no React, no platform APIs, so it's
// trivially testable and reused identically by client/src/lib/calendarModel.ts
