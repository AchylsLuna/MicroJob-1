...
const styles = StyleSheet.create({
  ...
  refreshButton: { width: 44, height: 44, borderRadius: 15, backgroundColor: 'transparent', alignItems: 'center', justifyContent: 'center' },
  ...
  empty: { alignItems: 'center', paddingVertical: 22, paddingHorizontal: 12 }, emptyIcon: { width: 54, height: 54, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: 'transparent' }, emptyTitle: { marginTop: 10, fontSize: 15, fontWeight: '800', color: tokens.colors.text }, emptyBody: { marginTop: 5, textAlign: 'center', fontSize: 12, lineHeight: 17, color: tokens.colors.textMuted },
  transaction: { minHeight: 76, paddingVertical: 11, borderBottomWidth: 1, borderBottomColor: tokens.colors.border, flexDirection: 'row', alignItems: 'center', gap: 10 }, transactionIcon: { width: 40, height: 40, borderRadius: 13, backgroundColor: 'transparent', alignItems: 'center', justifyContent: 'center' }, creditIcon: { backgroundColor: 'transparent' }, debitIcon: { backgroundColor: 'transparent' }, transactionCopy: { flex: 1, minWidth: 0 }, transactionTitle: { fontSize: 13, fontWeight: '800', color: tokens.colors.text }, transactionSubtitle: { marginTop: 2, fontSize: 11, color: tokens.colors.textMuted }, transactionDate: { marginTop: 3, fontSize: 10, color: tokens.colors.textSubtle }, transactionAmountWrap: { alignItems: 'flex-end', maxWidth: '36%' }, transactionAmount: { fontSize: 13, fontWeight: '800', color: tokens.colors.brandDark }, creditText: { color: '#15803D' }, debitText: { color: '#B91C1C' }, status: { marginTop: 5, paddingHorizontal: 7, paddingVertical: 3, borderRadius: tokens.radius.pill, backgroundColor: tokens.colors.contentMuted }, statusSuccess: { backgroundColor: tokens.colors.successSoft }, statusDanger: { backgroundColor: tokens.colors.dangerSoft }, statusPending: { backgroundColor: tokens.colors.warningSoft }, statusText: { fontSize: 9, fontWeight: '800', color: tokens.colors.textMuted, textTransform: 'uppercase' },
});
