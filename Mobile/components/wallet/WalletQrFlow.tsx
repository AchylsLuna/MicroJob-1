...
const styles = StyleSheet.create({
  ...
  jobRow: { minHeight: 76, padding: 13, borderRadius: 17, borderWidth: 1, borderColor: tokens.colors.border, backgroundColor: tokens.colors.surface, flexDirection: 'row', alignItems: 'center', gap: 12 }, jobIcon: { width: 42, height: 42, borderRadius: 13, backgroundColor: 'transparent', alignItems: 'center', justifyContent: 'center' }, grow: { flex: 1 }, jobTitle: { fontSize: 14, fontWeight: '800', color: tokens.colors.text }, empty: { minHeight: 220, alignItems: 'center', justifyContent: 'center', padding: 20 },
