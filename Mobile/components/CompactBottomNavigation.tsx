...
const styles = StyleSheet.create({
  ...
  emphasizedItem: { transform: [{ translateY: -3 }] },
  ...
  iconEmphasized: { width: 40, height: 40, borderRadius: 20, backgroundColor: tokens.colors.brand, borderWidth: 2, borderColor: tokens.colors.surface, shadowColor: tokens.colors.brandDark, shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.18, shadowRadius: 5, elevation: 4 },
