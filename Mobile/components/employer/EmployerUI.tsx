...
const styles = StyleSheet.create({
  ...
  actionIcon: { width: 36, height: 36, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: 'transparent' }, actionIconPrimary: { backgroundColor: 'transparent' }, actionIconDanger: { backgroundColor: 'transparent' }, actionLabel: { flex: 1, color: tokens.colors.brandDark, fontSize: 14, fontWeight: '800' }, actionLabelPrimary: { color: tokens.colors.onBrand }, actionLabelDanger: { color: tokens.colors.danger },
  ...
  accordionIcon: { width: 36, height: 36, borderRadius: 11, alignItems: 'center', justifyContent: 'center', backgroundColor: 'transparent' },
