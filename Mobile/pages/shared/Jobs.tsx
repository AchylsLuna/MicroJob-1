...
export default function Jobs({ onBack, onViewDetails, onToggleSave, savedJobIds = [], activeTab: externalActiveTab, onTabPress: externalOnTabPress }: { onBack?: () => void; onViewDetails?: (job: any) => void; onToggleSave?: (job: Job) => void; savedJobIds?: string[]; activeTab?: string; onTabPress?: (tab: string) => void }) {
