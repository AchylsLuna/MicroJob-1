...
const styles = StyleSheet.create({
  ...
  employerContext: { marginTop: 2, color: tokens.colors.brand, fontSize: 11, fontWeight: '900', letterSpacing: 0.8 },
  notificationIcon: {
    position: 'relative',
    width: 44,
    height: 44,
  ...
  invoiceCard: { width: '88%', alignSelf: 'flex-start', marginBottom: 12, padding: 13, borderRadius: 19, borderWidth: 1, borderColor: tokens.colors.border, backgroundColor: tokens.colors.surface, ...tokens.shadow.card }, invoiceMine: { alignSelf: 'flex-end', borderColor: '#BFDBFE' }, invoiceTheirs: { alignSelf: 'flex-start' }, invoiceHeader: { flexDirection: 'row', alignItems: 'center', gap: 9 }, invoiceIcon: { width: 40, height: 40, borderRadius: 12, backgroundColor: 'transparent', alignItems: 'center', justifyContent: 'center' }, invoiceCopy: { flex: 1 }, invoiceEyebrow: { fontSize: 10, fontWeight: '800', letterSpacing: .8, color: tokens.colors.brand }, invoiceTitle: { marginTop: 2, fontSize: 13, fontWeight: '800', color: tokens.colors.brandDark }, invoiceStatus: { paddingHorizontal: 7, paddingVertical: 4, borderRadius: 999, backgroundColor: tokens.colors.successSoft }, invoiceStatusMuted: { backgroundColor: tokens.colors.contentMuted }, invoiceStatusText: { fontSize: 10, fontWeight: '800', color: tokens.colors.textMuted, textTransform: 'uppercase' }, invoiceQr: { width: 180, height: 180, alignSelf: 'center', marginVertical: 12, backgroundColor: '#FFFFFF' }, invoiceFooter: { borderTopWidth: 1, borderTopColor: tokens.colors.border, paddingTop: 10 }, invoiceAmount: { fontSize: 19, fontWeight: '800', color: tokens.colors.brandDark }, invoiceCode: { marginTop: 5, fontSize: 11, fontWeight: '800', letterSpacing: 1, color: tokens.colors.brand }, invoiceHint: { marginTop: 3, fontSize: 10, color: tokens.colors.textMuted },
